...
public class UserPassFragment extends Fragment {
    ...
    public static UserPassFragment newInstance(String param1, String param2, String param3, String param4) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                ConfirmationDialog selectProfileDialog = ConfirmationDialog.newInstance(UserPassFragment.this, device, imei, profile);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        System.out.println("Holaaaaaa"+profile);


        if(id == R.id.salvar){
            if(user.getText().length() == 0 || user.getText().toString().isEmpty()){
                user.setError("El campo es obligatorio");
            }
            if(pass.getText().length() == 0 || pass.getText().toString().isEmpty()){
                pass.setError("El campo es obligatorio");
            }

            if(user.getText().length() != 0 && !user.getText().toString().isEmpty() && pass.getText().length() != 0 && !pass.getText().toString().isEmpty()) {
                configViewModel.saveUserPass(user.getText().toString(), pass.getText().toString(), device);
                ...
                NavHostFragment.findNavController(UserPassFragment.this)
