...
public class Config_Horario_Noche extends SugarRecord<Config_Horario_Noche> {
    ...
    public Config_Horario_Noche() {
    }

    public Config_Horario_Noche(String hora_activo, String minuto_activo, String hora_inactivo, String minuto_inactivo,
                                int tipo_juego) {
